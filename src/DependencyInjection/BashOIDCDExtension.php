...
class BashOIDCDExtension extends ConfigurableExtension
{
    public const BASE_ID = 'bash.oidcd.';
    ...
    public function loadInternal(array $mergedConfig, ContainerBuilder $container): void
    {
        ...
        // Setup default alias
        $container
            ->setAlias(OidcdClientInterface::class, sprintf('bash.oidcd.client.%s', $mergedConfig['default_client']));
    ...
    private function registerClient(ContainerBuilder $container, string $name, array $config): Reference
    {
        ...
        $container
            ->registerAliasForArgument($clientId, OidcdClientInterface::class, sprintf('%sOidcClient', $name));
